...
int main (int argc, char ** argv)
{
  if (argc<2)
  {  
    printf ("Oops! You didn't say the hair world file!\n");
    printf ("Usage: %s [worldfile]\n", argv[0]);
    exit(0);
  }

  readWorld(argv[1],&hair,  0.0, 0.0);
  readWorld(argv[1],&hair2, 0.0, strandOffset);
  hair.pushedByWind  = true;
  hair2.pushedByWind = false;
